...
import ValhallaMetal from './assets/valhalla_metal.wav';
...
const renderContent = () => {
  ...
  if (!currentAccount) {
    ...
    return <SelectPassport setCharacterNFT={setCharacterNFT} />;
  }
};
    ...
    <div className="App">
      <div className="container">      
        <div className="sound-box">
          ...
          <span className="sound-toggle-no-animation">
            <a href={"https://testnets.opensea.io/collection/passport-0rnuwza4jr"} target="_blank" rel="noreferrer">⛵</a>  
          </span>
        </div>
        <div className="error">{metaMaskMsg ? 'You need MetaMask to play!' : ''}</div>
        <div className="header glow-text gradient-text">DEIVERSE
          <p className="sub-text">DIVERSITY EQUITY INCLUSION</p>
        </div>
        {renderContent()}
      </div>
      <Sound
      ...
      <div className="footer-container">
        ...
        &copy; 2021 Deiverse Created with by <b>Kei Nakano</b>
      </div>
    </div>
  );
};
